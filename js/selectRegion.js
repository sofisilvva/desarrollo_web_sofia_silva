...
const data =  {
  ...
  "Ñuble": ["Chillán", "Chillán Viejo", "Quillón", "Bulnes", "San Ignacio", "Pemuco", "El Carmen", "Yungay", "Quirihue", "Cobquecura", "Ninhue", "Trehuaco", "Coelemu", "Portezuelo", "Ránquil", "San Carlos", "San Fabián", "Ñiquén", "San Nicolás", "Coihueco", "Pinto"],
  "Biobío": ["Concepción", "Coronel", "Chiguayante", "Florida", "Hualqui", "Lota", "Penco", "San Pedro de la Paz", "Santa Juana", "Talcahuano", "Tomé", "Lebu", "Arauco", "Cañete", "Contulmo", "Curanilahue", "Los Álamos", "Tirúa", "Los Ángeles", "Antuco", "Cabrero", "Laja", "Mulchén", "Nacimiento", "Negrete", "Quilaco", "Quilleco", "San Rosendo", "Santa Bárbara", "Tucapel", "Yumbel"],
